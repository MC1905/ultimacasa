...
window.addEventListener('beforeunload', function (e) {
    ...
    var confirmationMessage = 'Weet je zeker dat je wilt teruggaan naar het oorspronkelijke tabblad? Niet-opgeslagen wijzigingen gaan mogelijk verloren.';



    (e || window.event).returnValue = confirmationMessage; // Voor oudere browsers

    return confirmationMessage; // Voor moderne browsers
